                ...
                [
                  _c("Label", {
                    ...
                    attrs: {
                      ...
                      text: _vm._f("fonticon")("mdi-account")
                    }
                  }),
                  _c("Label", {
                    staticClass: "drawer-item",
                    attrs: { row: "0", col: "1", text: "Item 1" }
                  }),
                  _c("Label", {
                    staticClass: "drawer-item",
                    attrs: { row: "1", col: "1", text: "Item 1 description" }
                  })
                ],
                1
              )
